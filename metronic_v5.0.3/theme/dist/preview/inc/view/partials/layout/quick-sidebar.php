<!-- begin::Quick Sidebar -->
<div id="m_quick_sidebar" class="m-quick-sidebar m-quick-sidebar--tabbed m-quick-sidebar--skin-<?php echo Page::getOption('layout', 'quick-sidebar/skin')?>">
					...
					<div class="m-messenger__messages">
						<div class="m-messenger__message m-messenger__message--in">
							<div class="m-messenger__message-pic">
								<img src="<?php echo Page::getMediaImgPath();?>/users/user3.jpg" alt=""/>
							</div>
