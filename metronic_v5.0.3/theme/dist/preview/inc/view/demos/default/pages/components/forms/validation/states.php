				...
				<div class="m-portlet__body">	
					<div class="form-group m-form__group has-success">
						<label class="form-control-label" for="inputSuccess1">Input with success</label>
					  	<input type="text" class="form-control form-control-success m-input" id="inputSuccess1">
					...
					<div class="form-group m-form__group has-warning">
					  	...
					  	<input type="text" class="form-control form-control-warning m-input" id="inputWarning1">
			...
			<form class="m-form">
				<div class="m-portlet__body">				
					<div class="form-group m-form__group has-success row">
						...
						<div class="col-lg-9">
						  	<input type="text" class="form-control form-control-success m-input m-input--solid" id="inputSuccess1">
						  	<div class="form-control-feedback">Success! You've done it.</div>
						  	<span class="m-form__help">Example help text that remains unchanged.</span>
					  	</div>
					</div>
					<div class="form-group m-form__group has-warning row">
					  	...
					  	<div class="col-lg-9">
						  	<input type="text" class="form-control form-control-warning m-input m-input--pill" id="inputWarning1">
						  	<div class="form-control-feedback">Shucks, check the formatting of that and try again.</div>
						  	<span class="m-form__help">Example help text that remains unchanged.</span>
					  	</div>
					</div>
					<div class="form-group m-form__group has-danger row">
					  	...
					  	<div class="col-lg-9">
						  	<input type="text" class="form-control form-control-danger m-input m-input--air" id="inputDanger1">
						  	<div class="form-control-feedback">Sorry, that username's taken. Try another?</div>
						  	<span class="m-form__help">Example help text that remains unchanged.</span>
					  	</div>
					</div>
			...
			<form class="m-form">
				<div class="m-portlet__body">				
					<div class="form-group m-form__group has-success">
						<label class="form-control-label" for="inputSuccess1">Left Addon</label>
					  	<div class="input-group m-input-group">
						  	<span class="input-group-addon" id="basic-addon1"><i class="la la-bar-chart"></i></span>
							<input type="text" class="form-control form-control-success m-input" placeholder="Email" aria-describedby="basic-addon1">
						</div>
					  	<div class="form-control-feedback">Success! You've done it.</div>
					  	<span class="m-form__help">Example help text that remains unchanged.</span>
					</div>
					<div class="form-group m-form__group has-warning">
					  	...
					  	<div class="input-group m-input-group">
						  	<input type="text" class="form-control form-control-warning m-input" value="4444a" placeholder="Email" aria-describedby="basic-addon1">
					...
					<div class="form-group m-form__group has-danger">
					  	...
					  	<div class="input-group m-input-group">
						  	...
						  	<input type="text" class="form-control form-control-danger m-input" placeholder="Email" aria-describedby="basic-addon1">
						  	<span class="input-group-addon" id="basic-addon1"><i class="la la-comments"></i></span>
						</div>
					  	<div class="form-control-feedback">Sorry, that username's taken. Try another?</div>
					  	<span class="m-form__help">Example help text that remains unchanged.</span>
					</div>
