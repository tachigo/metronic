    ...
    <div class="col-lg-6">
        ...
        <div class="m-portlet">
        	...
        	<div class="m-portlet__body">
                ...
                <div class="m-section">
                    <span class="m-section__sub">
                        Dropdowns can be toggled via click or hover by setting <code>data-dropdown-toggle="hover"</code> and <code>data-dropdown-toggle="click"</code>:
                    </span>
                ...
                <div class="m-section">
                    <span class="m-section__sub">
                        Dropdowns can be shown persistent when toggled by click to avoid closing on mouse click on it<code>data-dropdown-persistent="true"</code>:
                    </span>
                    <div class="m-section__content">
