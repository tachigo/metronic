...
<!--begin::Portlet-->
<div class="m-portlet m-portlet--tabs <?php Util::echoIf(Page::getOption('layout', 'content/portlet/rounded'), 'm-portlet--rounded')?>">
		...
		<div class="m-portlet__body">
			<div class="tab-content">
				<div class="tab-pane <?php Page::classValue( $tabId, '#m_builder_page' ); ?>" id="m_builder_page">
					...
					<div class="form-group m-form__group row">
						<label class="col-lg-4 col-form-label">Fixed Content(desktop):</label>
						<div class="col-lg-8 col-xl-4">
							<input type="hidden" name="builder[layout][content][fixed][desktop]" value="false">
							<span class="m-switch m-switch--icon-check">
								<label>
									<input type="checkbox" name="builder[layout][content][fixed][desktop]" value="true" <?php Util::echoIf(Page::getOption('layout', 'content/fixed/desktop'), 'checked');?> />
							        <span></span>
							    </label>
							</span>
							<div class="m-form__help">Set fixed scrollable page content for desktop</div>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label class="col-lg-4 col-form-label">Fixed Content(mobile):</label>
						<div class="col-lg-8 col-xl-4">
							<input type="hidden" name="builder[layout][content][fixed][mobile]" value="false">
							<span class="m-switch m-switch--icon-check">
								<label>
									<input type="checkbox" name="builder[layout][content][fixed][mobile]" value="true" <?php Util::echoIf(Page::getOption('layout', 'content/fixed/mobile'), 'checked');?> />
							        <span></span>
							    </label>
							</span>
							<div class="m-form__help">Set fixed scrollable page content for mobile</div>
						</div>
					</div>
					<div class="form-group m-form__group row">
				...
				<div class="tab-pane <?php Page::classValue( $tabId, '#m_builder_header' ); ?>" id="m_builder_header">
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-8 col-xl-4">
							...
							<div class="m-form__help">Enable fixed header for desktop mode. This option will be applied only when the fixed content options is disabled.</div>
						</div>
					</div>
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-8 col-xl-4">
							...
							<div class="m-form__help">Enable fixed header for mobile mode. This option will be applied only when the fixed content options is disabled.</div>
						</div>
					</div>
